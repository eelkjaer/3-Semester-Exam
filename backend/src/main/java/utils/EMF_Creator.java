...
public class EMF_Creator {
  ...
  private static EntityManagerFactory createEntityManagerFactory(boolean isTest) {
    ...
    if (isDeployed) {
      ...
      String connection_str = System.getenv("CONNECTION_STR") + dbName + "?useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&useTimezone=true&serverTimezone="+timezone; //Creates the full JDBC connection string
